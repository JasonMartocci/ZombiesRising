    ...
    $.ajax({
        ...
        success: function(data){
          ...
          for(var i = 0; i < data.enemies.length; i++) {
           ...
           Q.load(characterAssetsString + '/assets/audio/brainzzz.mp3, /assets/images/scoreBoard.png, /assets/audio/Homer_Mmmm_donuts.mp3, /assets/images/background.jpg, /assets/images/buttonBg1.png, /assets/images/sun.png, /assets/images/bullet.png, /assets/audio/boom.mp3, /assets/audio/hit.mp3, /assets/data/level1.json, /assets/data/level2.json, /assets/data/level3.json, /assets/data/level4.json', function() {
